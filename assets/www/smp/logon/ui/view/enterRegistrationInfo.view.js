sap.ui.jsview("view.enterRegistrationInfo", {
    ...
    createContent: function(oController) {
            ...
            var buttonOKPress = function() {
                ...
                //data.user = "LNTCORP" +"\\" +inputUsername.getValue().trim(); //For Prod - Not used as hardcoding involved
                data.user = inputUsername.getValue().trim().toUpperCase();  //For Dev & QA & Prod
            ...
            //cancelRegistration.setVisible(false); //For iOS
           ...
           /* var instructionText = new sap.m.Text('reg_instr_text', {
            ...
            var instructionText = new sap.m.Text('reg_instr_text', {
                text: "Login with your domain credential to start e.g. : LNTCORP\\1234567"
